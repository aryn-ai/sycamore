...
Sycamore is an AI-powered document segmenation and enrichment framework for LLMs, RAG, and unstructured analytics. Sycamore makes it easy to reliably load your vector databases and hybrid search engines with higher quality data. It can process and prepare a wide range of document types including reports, presentations, transcripts, manuals, and more. Sycamore can analyze and chunk complex documents such as PDFs and images with embedded tables, figures, graphs, and other infographics. It provides an advanced document partitioner for high fidelity segmentation and chunking, and can also integrate with your choice of AI models for LLM-powered UDFs, vector embeddings, and other data transformations. It supports a variety of engines such as OpenSearch and Weaviate and reads from Amazon S3.
