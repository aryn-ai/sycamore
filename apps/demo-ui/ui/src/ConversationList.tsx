...
const NavBarConversationItem = ({ conversation, conversations, setConversations, selectConversation, loading, settings, setSettings, setChatHistory, setNavBarOpened }: { conversation: any, conversations: any[], setConversations: any, selectConversation: any, loading: any, settings: any, setChatHistory: any, setSettings: Dispatch<SetStateAction<Settings>>, setNavBarOpened: any }) => {
