...
If you'd like to experiment with the service, you can use the UI in the `Aryn Playground <https://play.aryn.cloud/partitioning>`_ to visualize how your documents will be partitioned. To get started with the Aryn Partitoning Service, please checkout the following pages.
