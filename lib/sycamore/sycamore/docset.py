...
class DocSet:
    ...
    def count(self, field: Optional[str] = None, include_metadata=False, **kwargs) -> int:
        """
        ...
        **kwargs
        ...
        Returns:
            The number of documents in the docset. If field is specified, number of
            documents with a unique value for field.
        ...
        for row in dataset.iter_rows():
            ...
            if field is not None:
                ...
                count = count + 1
        return len(unique_docs) if field is not None else count
