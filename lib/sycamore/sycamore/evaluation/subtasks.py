...
from sycamore.llms.prompts.default_prompts import SimplePrompt, TaskIdentifierZeroShotGuidancePrompt
...
class SubtaskExecutor:
    def __init__(
        ...
        prompt: SimplePrompt = TaskIdentifierZeroShotGuidancePrompt(),
