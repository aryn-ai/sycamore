...
J_ELEMENT_BATCHED_LIST = J_BATCH_OOB_CHECK + """\
...
J_ELEMENT_BATCHED_LIST_WITH_METADATA = J_BATCH_OOB_CHECK + """\
{% for i in doc.properties[batch_key][doc.properties[iteration_var]] -%}
{%- set elt = doc.elements[i] -%}
...
J_DYNAMIC_DOC_TEXT = """{%- set field = "text_representation" -%}
...
{% elif num_elements is defined %}""" + J_ELEMENT_LIST_CAPPED + "{% else %}" + J_ELEMENT_LIST_UNCAPPED + "{% endif %}"
