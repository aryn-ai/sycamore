...
class Count(LogicalOperator):
    ...
    def description() -> str:
        return """
        **Count**: Determines the length of a particular data table. Parameters are *description*, *input*, *field*, *primaryField*, and *id*. Returns a number.
        ...
        - *primaryField* is an optional parameter. It is a primary field that represents what a unique entry is considered for the data provided.
