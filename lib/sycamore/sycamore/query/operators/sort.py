...
class Sort(LogicalOperator):
    ...
    def description() -> str:
        return """
        **Sort**: Sorts a data table based on the value of a field. Parameters are *description*, *descending*, *field*, *input*, and *id*. Returns an ordered data table.
        ...
        - *descending* is a Boolean that determines whether to sort in descending order (greatest value first)
