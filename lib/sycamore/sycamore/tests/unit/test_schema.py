...
def test_boolean_validator_range_comparisons():
    ...
    assert validator.validate_property(1800)[0] is False
...
def test_boolean_validator_field_references():
    ...
    assert validator.validate_property(2015, {"year_built": 2008})[0] is True
    assert validator.validate_property(None, {"year_built": 1995})[0] is True
    assert validator.validate_property(1990, {"year_built": 1995})[0] is False
    assert validator.validate_property(2026, {"year_built": 1995})[0] is False
    assert validator.validate_property(2000, {})[0] is False
