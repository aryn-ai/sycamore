...
class TestKMeans:
    ...
    # I think hash-shuffles or setting num_partitions makes this
    # not flaky? -henry
    ...
    def test_kmeans(self):
        ...
        centroids = docset.kmeans(3, 4, num_partitions=1)
    ...
    def test_converge(self):
        ...
        new_centroids = KMeans.update(embeddings, centroids, 2, 1e-4, num_partitions=1)
