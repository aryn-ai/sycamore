    ...
    def opensearch(
        ...
        **kwargs,
        ...
        if os_client_args is None:
            os_client_args = self.context.opensearch_client_config
        assert os_client_args is not None, "OpenSearch client args required"

        if not index_name:
            index_name = self.context.opensearch_index_name
        ...
        if index_settings is None:
            index_settings = self.context.opensearch_index_settings
