...
class SentenceTransformerEmbedding(Transform):
    ...
    class SentenceTransformer:
        ...
        def __call__(
            ...
            embed_batch = doc_batch["embedding"].tolist()
            ...
            for idx, embedding in enumerate(embed_batch):
                embedding.update({"text": embeddings[idx]})
            doc_batch.update({"embedding": np.array(embed_batch)})
