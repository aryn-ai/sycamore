...
SCHEMA_ZERO_SHOT_GUIDANCE_PROMPT_CHAT = """
    ...
    {{#user~}}
    You are given a few text elements of a document. Extract JSON Schema representing one entity of
    class {{entity}} from the document. Using this context, FIND, FORMAT, and RETURN the JSON-LD Schema.
    Return a flat schema, without nested properties. Return at most 7 properties.
...
SCHEMA_ZERO_SHOT_GUIDANCE_PROMPT = """
    ...
    class {{entity}} from the document. Using this context, FIND, FORMAT, and RETURN the JSON
    representing one {{entity}}. Only return JSON as part of your answer.
    {{query}}
    =========
    {{gen "answer"}}
    """
...
PROPERTIES_ZERO_SHOT_GUIDANCE_PROMPT_CHAT = """
    ...
    The JSON has format: {{properties}}. Using this context RETURN the JSON representing one {{entity}}.
    Only return JSON as part of your answer. If no entity is in the text, return "None".
    {{query}}
    {{~/user}}
